...
<div class="easyui-panel" data-options="fit:true,border:false">
	<div id="user_toolbar">
		<a id="depart_add" href="javascript:void(0)" class="easyui-linkbutton"
			data-options="iconCls:'icon-add',plain:true">添加部门</a> 
			<a id="depart_add_user" href="javascript:void(0)" class="easyui-linkbutton"
			data-options="iconCls:'icon-add',plain:true">添加人员</a><a id="user_edit"
	...
	<table width="800" cellspacing="1"
		cellpadding="5" bgcolor="#000000" border="0" align="center"
